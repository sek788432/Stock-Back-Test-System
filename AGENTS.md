...
3. Read the relevant shared [`.agents/skills/*/SKILL.md`](.agents/skills/) rules.
4. Read the relevant repository-specific `.cursor/skills/*/SKILL.md` rules.
5. Confirm the work passes [`Docs/DEFINITION_OF_DONE.md`](Docs/DEFINITION_OF_DONE.md) before declaring a task complete.
