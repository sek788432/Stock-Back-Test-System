...
| 0012 | [Enforce static analysis and diff coverage](0012-enforce-static-analysis-and-diff-coverage.md) | Superseded in part by 0017 and 0018 |
...
| 0018 | [Run full static analysis on manual and scheduled CI](0018-run-full-static-analysis-on-manual-and-scheduled-ci.md) | Accepted |
